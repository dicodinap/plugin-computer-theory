...
/**
 * Implication binary node in the formula AST.
 *
...
/**
 * Represents φ → ψ — material implication.
 */
final class impl_node extends formula_ast {
    /** Unicode symbol for implication. */
    public const SYMBOL = '→';
    ...
    /**
     * Build an implication node.
     *
     * @param formula_ast $left  Antecedent.
     * @param formula_ast $right Consequent.
     */
    ...
    /**
     * Return false only when the antecedent is true and the consequent is false.
     *
     * Equivalently: !l || r.
     *
