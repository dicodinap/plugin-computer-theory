...
/**
 * Conjunction binary node in the formula AST.
 *
...
/**
 * Represents φ ∧ ψ — logical conjunction.
 */
final class and_node extends formula_ast {
    /** Unicode symbol for conjunction. */
    public const SYMBOL = '∧';
    ...
    /**
     * Return true iff both operands are true.
     *
