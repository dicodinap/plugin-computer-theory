...
/**
 * Biconditional binary node in the formula AST.
 *
...
/**
 * Represents φ ↔ ψ — biconditional (if and only if).
 */
final class iff_node extends formula_ast {
    /** Unicode symbol for biconditional. */
    public const SYMBOL = '↔';
    ...
    /**
     * Return true iff both operands have the same truth value.
     *
     * Decision: use strict equality (l === r) because operands are bool.
     *
